...
with tab2:
    ...
    def load_cleaned_data():
        df = pd.read_csv("../data/cleaned_business_data.csv", parse_dates=["dba_start_date"])
...
with tab3:
    ...
    st.subheader("📍 Kaplan-Meier Curves by License Type")
    ...
    # --- Kaplan-Meier Curves by Neighborhood ---
    st.subheader("📍 Kaplan-Meier Curves by Neighborhood")
